...
parser.add_argument("--plot-train", help="save also the plots of the scores on the training set", action="store_true")
...
def main():
    ...
    model.train(plot_folder=parsed_args.plot_folder, plot_train=parsed_args.plot_train)
